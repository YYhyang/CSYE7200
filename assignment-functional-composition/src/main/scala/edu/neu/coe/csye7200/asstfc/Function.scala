...
object Function {
  ...
  def map7[T1, T2, T3, T4, T5, T6, T7, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7])
                                         (f: (T1, T2, T3, T4, T5, T6, T7) => R): Try[R] = t1y flatMap(a=>t2y flatMap(b=>t3y flatMap(c=>t4y flatMap(d=>t5y flatMap(e=>t6y flatMap(g=>t7y map(h=>f(a,b,c,d,e,g,h))))))))// TO BE IMPLEMENTED
...
//  }// TO BE IMPLEMENTED
  ...
  def invert2[T1, T2, R](f: T1 => T2 => R): T2 => T1 => R = t2y => t1y => f(t1y)(t2y) // TO BE IMPLEMENTED
  ...
  def invert3[T1, T2, T3, R](f: T1 => T2 => T3 => R): T3 => T2 => T1 => R = t3y=> t2y=> t1y=> f(t1y)(t2y)(t3y) // TO BE IMPLEMENTED
  ...
  def invert4[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): T4 => T3 => T2 => T1 => R = t4y=> t3y=> t2y=> t1y=> f(t1y)(t2y)(t3y)(t4y)// TO BE IMPLEMENTED
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (t1y,t2y) =>t3y=>f(t1y)(t2y)(t3y) // TO BE IMPLEMENTED
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (t1y,t2y,t3y)=>t4y=>f(t1y)(t2y)(t3y)(t4y) // TO BE IMPLEMENTED
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R =
    (t1y,t2y,t3y,t4y,t5y,t6y,t7y)=>t8y=>f(t1y)(t2y)(t3y)(t4y)(t5y)(t6y)(t7y)(t8y) // TO BE IMPLEMENTED
